...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4ef6b066bdb5ce5e20b56cbf511fcbf3) *)
(*
...
(* # 21 "/home/bob/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     doc = [("pretty-monospace", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("pretty-monospace", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("pretty-monospace",
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A pretty printing library for monospaced output";
          description = None;
          categories = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Documentation for pretty-monospace";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("camlcheck", None);
                           InternalLibrary "pretty-monospace"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\020e\195J\\\136\211if.\144\205\190\229\133\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
