...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4ab9698f23c66f5b1c64cdb218efcba3) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("monopretty", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("monopretty", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "`B\127\250j\166(X\133\1435\t\234B\183\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
