...
type document_context =
  | Hole
  | Append1 of document_context * Pretty.Document.t
  | Append2 of Pretty.Document.t * document_context
...
let rec string_of_document_context = function
  | Hole         -> "Hole"
  | Append1(c,d) -> "Append1(" ^ string_of_document_context c ^ ", " ^ to_string d ^ ")"
  | Append2(d,c) -> "Append2(" ^ to_string d ^ ", " ^ string_of_document_context c ^ ")"
...
let prop_nest_nest =
  Property.forall (Domain.int_range 0 12) @@ fun n1 ->
    Property.forall (Domain.int_range 0 12) @@ fun n2 ->
      Property.forall document @@ fun d ->
